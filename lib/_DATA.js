...
const questions = {
  ...
  [3]: {
    creator: "Isabella",
    question: "Buy twitter for 44B or keep the money",
    options: [
      { text: "Buy twitter for 44B", count: 1 },
      {
        text: "Keep the 44 billion dollars",
        count: 1,
      },
    ],
    leader: null,
...
const employees = {
  ...
  Isabella: { answered: 1, polls: 0 },
  Afra: { answered: 2, polls: 1 },
  Donghai: { answered: 2, polls: 1 },
  Brian: { answered: 1, polls: 0 },
